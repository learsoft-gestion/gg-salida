...
func ProcesadosSalida(db *sql.DB, id_proceso int, id_modelo int, fecha1 string, fecha2 string, version int, cant_registros int, nombre_salida string, procesado_salida bool) error {
...
func ProcesadosControl(db *sql.DB, id_proceso int, id_modelo int, fecha1 string, fecha2 string, version int, cant_registros int, nombre_control string, procesado_control bool) error {
